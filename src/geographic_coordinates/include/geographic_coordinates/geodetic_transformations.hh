...
public:
  ...
  [[nodiscard]] real origin_latitude_deg() const
  {
    return m_orig_latitude * 180 / std::numbers::pi;
  }
  ...
  [[nodiscard]] real origin_longitude_deg() const
  {
    return m_orig_longitude * 180 / std::numbers::pi;
  }
  ...
  //!
  void compute_unit_vector_north(
  ...
  //!
  void
  convert_ECEF_to_ENU(real x_ecef, real y_ecef, real z_ecef, real &x_east, real &y_north, real &z_up) const;
  ...
  //! \param z_up    [out] local up coordinate (m)
  //!
  void convert_geodetic_coords_to_ENU(
  ...
  //!
  void
  convert_ENU_to_ECEF(real x_east, real y_north, real z_up, real &x_ecef, real &y_ecef, real &z_ecef) const;
  ...
  //!
  void convert_ECEF_to_geodetic_coords(
  ...
  //! \param h       [out] geodetic height (m)
  //!
  void convert_ENU_to_geodetic_coords(
