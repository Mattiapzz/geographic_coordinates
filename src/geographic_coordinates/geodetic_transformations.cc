...
void GeodeticTransformations::set_origin(real phi, real lambda, real height)
{
  ...
  compute_unit_vector_north(
    m_orig_latitude, m_orig_longitude, m_orig_uvec_north_x, m_orig_uvec_north_y, m_orig_uvec_north_z
  );
}

void GeodeticTransformations::info(std::ostream &stream) const
{
  stream
...
void GeodeticTransformations::compute_norm_to_ellipsoid(
  real lat, real lon, real &norm_x, real &norm_y, real &norm_z
) const
{
...
void GeodeticTransformations::compute_unit_vector_east(
  real lon, real &uvec_east_x, real &uvec_east_y, real &uvec_east_z
) const
{
...
void GeodeticTransformations::compute_unit_vector_north(
  real lat, real lon, real &uvec_north_x, real &uvec_north_y, real &uvec_north_z
) const
{
...
void GeodeticTransformations::convert_geodetic_coords_to_ECEF(
...
void GeodeticTransformations::convert_ECEF_to_ENU(
...
void GeodeticTransformations::convert_geodetic_coords_to_ENU(
...
void GeodeticTransformations::convert_ENU_to_ECEF(
...
void GeodeticTransformations::convert_ECEF_to_geodetic_coords(
...
void GeodeticTransformations::convert_ENU_to_geodetic_coords(
